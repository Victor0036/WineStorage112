...
public class AddNote extends AppCompatActivity {
    Toolbar toolbar;
    EditText noteTitle,noteDetails, producer, vintage, grapes;
    Calendar c;
    String todaysDate;
    String currentTime;
    Spinner country;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId() == R.id.save){
            if(noteTitle.getText().length() != 0){
                Note note = new Note(noteTitle.getText().toString(),noteDetails.getText().toString(),todaysDate,currentTime,producer.getText().toString(),vintage.getText().toString(),countryString,grapes.getText().toString());
